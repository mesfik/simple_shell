...
/**
 * help_all - function that displays builtin shellby
 *
 * Return: Nothing
 */
void help_all(void)
...
/**
 * help_cd - function that displays builtin shellby
 *
 * Return: Nothing
 */
void help_cd(void)
...
/**
 * help_exit - function that displays builtin shellby
 *
 * Return: Nothing
 */
void help_exit(void)
...
/**
 * help_help - function that displays builtin shellby
 *
 * Return: Nothing
 */
void help_help(void)
